...
class CreateCourseExersiceFormComponent(BaseComponent):
    def __init__(self, page: Page):
        super().__init__(page)

        self.delete_exersice_button = Button(
    ...
    def click_delete_button(self, index: int):
        self.delete_exersice_button.click(index=index)

    @allure.step('Check create course exercise form with index "{index}" visibility')
    ...
    @allure.step('Fill create course exercise form with index "{index}"')
